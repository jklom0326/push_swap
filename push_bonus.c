...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/07/18 02:51:18 by shan              #+#    #+#             */
/*   Updated: 2022/07/18 02:51:18 by shan             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include "push_swap_bonus.h"

void	px_operation_case_null_checker(t_node *dest_stack, t_node *src_stack,
								t_node *new_node)
{
...
void	pb_checker(t_node *stack_a, t_node *stack_b)
{
	...
	if (stack_b->next == NULL)
		...
		px_operation_checker(stack_b, stack_a, node);
